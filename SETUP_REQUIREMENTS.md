...
Storage'da özel orijinaller/taslaklar ve yayımlanmış görsel türevleri ayrılacak. Depo adlarını uygulama kurulurken belirleyebiliriz. Yükleme/okuma politikaları editör rolleriyle sınırlandırılır; özel önizlemeler yetkili erişim kullanır. Harita ve görsel dosyaları değişmez sürümlü anahtarlarla saklanır. Veritabanının yanında gerçek Storage dosyalarını da kapsayan dışa aktarma ve geri yükleme akışı kurulacak. [Storage erişim modeli](https://supabase.com/docs/guides/storage/buckets/fundamentals).
